...
class TeacherGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Teacher entity")
        ...
        .repeat(2) {
            ...
            .post("/api/teachers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "firstName":"SAMPLE_TEXT", "adress":"SAMPLE_TEXT", "phoneNumber":"SAMPLE_TEXT", "mobilePhoneNumber":"SAMPLE_TEXT", "email":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
